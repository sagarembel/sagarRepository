...
String creditCustomerName1 = (String) session.getAttribute("creditCustomerName1");

System.out.print(":::::::::::::::::::::::::::::::::::::::::BillNO :- "+ billno + "::::::::::::::::::::::::::::");
System.out.print(":::::::::::::::::::::::::::::::::::::::::creditCustomerName :- "+ creditCustomerName+ "::::::::::::::::::::::::::::");
System.out.print(":::::::::::::::::::::::::::::::::::::::::creditCustomerName :- "+ creditCustomerName1+ "::::::::::::::::::::::::::::");
System.out.print(":::::::::::::::::::::::::::::::::::::::::Paid Amt :- "+ paidAmt + "::::::::::::::::::::::::::::");
...
try {
	...
	//ResultSet rs = stmt.executeQuery("select c.ItemName, c.Quantity,c.BarcodeNo,c.EmpName,c.SalePrice, c.Discount, c.TotalAmount, c.GrossTotal, c.Date, c.totalperitem, c.Gst, c.Igst, c.TaxAmount, c.HsnSacNo , s.contact_no, s.first_name, c.pending_bill_payment, p.payment, c.BillNo from creditcustomerbill c left join customer_details s ON c.fkCrediCustId=s.pk_customer_id left join credit_customer_payment p ON c.BillNo = p.bill_no where c.BillNo ='"+billno+"'group by c.pkCrediBillId");
	ResultSet rs = stmt.executeQuery("select c.ItemName, c.Quantity, c.SalePrice, c.Discount, c.TotalAmount, c.GrossTotal, c.Date, c.totalperitem, c.Gst, c.Igst, c.TaxAmount, c.HsnSacNo , s.contact_no, s.first_name, s.last_name, c.pending_bill_payment,c.BarcodeNo,c.EmpName, payment_mode, c.fkCrediCustId from creditcustomerbill c left join customer_details s ON c.fkCrediCustId=s.pk_customer_id where c.BillNo = '"+billno+"' AND c.Quantity > 0 group by c.pkCrediBillId");
	...
	headerTable_cell21.setBorder(Rectangle.NO_BORDER);
	headertable21.addCell(headerTable_cell21);
	String customerName = creditCustomerName+" "+creditCustomerName1;
	...
	float[] columnWidths = { 0.1f, 0.7f, 0.3f, 0.4f, 0.5f };
...
//paidAmount = Total - billPaymentPending;
