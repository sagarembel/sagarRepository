...
<body class="vColor"
	...
	<div class="container col-md-offset-1" style="float: left">
		...
		<div class="row form-group" style="margin-top: 25px;">
			<label class="col-md-2 control-label" for="todayCashAmount">
				Cash Amount:
			</label>
			<div class="col-md-2">
				<div class="input-group">
			...
			<label class="col-md-2 col-md-offset-1 control-label" for="todayCardAmount">
				Card Amount:
			</label>
			<div class="col-md-2">
				<div class="input-group">
		...
		<div class="row form-group" style="margin-top: 25px;" hidden="true">
			...
			<label class="col-md-2 col-md-offset-1 control-label" for="todayNeftAmount">
				NEFT Amount:
			</label>
			<div class="col-md-2">
				<div class="input-group">
		...
		<div class="row form-group" style="margin-top: 25px;">
			...
			<label class="col-md-2 control-label" for="creditSaleCashAmount">
				Credit Sale Cash Amount:
			</label>
			<div class="col-md-2">
				<div class="input-group">
					<span class="input-group-addon"> <i
						class="fa fa-inr"></i>
					</span> <input type="text" readonly="readonly" name="creditSaleCashAmount" id="creditSaleCashAmount" class="form-control input-md ac_district" value="0">
				</div>
			</div>
			
			<label class="col-md-2 col-md-offset-1 control-label" for="creditSaleCardAmount">
				Credit Sale Card Amount:
			</label>
			<div class="col-md-2">
				<div class="input-group">
					<span class="input-group-addon"> <i
						class="fa fa-inr"></i>
					</span> <input type="text" readonly="readonly" name="creditSaleCardAmount" id="creditSaleCardAmount" class="form-control input-md ac_district" value="0">
				</div>
			</div>
