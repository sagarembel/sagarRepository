...
try {
	...
	ResultSet rs = stmt
			.executeQuery("select ItemName, CategoryName, Quantity, SalePrice, ContactNo, OwnerName, TotalAmount, Discount, GrossTotal, Date, totalperitem, TaxAmount,credit_Customer_Name,mobile_No,Gst,Igst,HsnSacNo,payment_mode,BarcodeNo,employee_Name from otherbill where BillNo ="
					+ billno);
	...
	headerTable_cell21 = new PdfPCell(new Phrase("Name: "	+ "",	font12Bold));
...
table_cell = new PdfPCell(new Phrase("\n\n\n\n\n      GST:" + gst1+ "% "+totalTaxAmount , font13));
...
table_cell = new PdfPCell(new Phrase("Discount: " + totalDiscount, font13));
table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
