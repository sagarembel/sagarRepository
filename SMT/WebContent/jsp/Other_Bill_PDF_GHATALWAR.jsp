...
<%
	...
	double tempTax = 0.0;
	double TotalOfTotalAmtWithoutVatStr = 0.0;
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("select ItemName, CategoryName, Quantity, SalePrice, ContactNo, OwnerName, TotalAmount, Discount, GrossTotal, Date, totalperitem, TaxAmount, credit_Customer_Name, mobile_No, Gst, Igst, HsnSacNo, payment_mode, perProductdisPer, taxAmtAfterDiscount, billTime from otherbill where BillNo = "+1);
		...
		headerTable_cell21 = new PdfPCell(new Phrase(rs.getString("Date")+"\n"+rs.getString("billTime"), font12Bold));
		headerTable_cell21.setHorizontalAlignment(Element.ALIGN_RIGHT);
		headerTable_cell21.setBorder(Rectangle.NO_BORDER);
		headertable21.addCell(headerTable_cell21);
		
		headerTable_cell21 = new PdfPCell(new Phrase(""+ customerName,font12Bold));
		//headerTable_cell21.setRowspan(8);
		headerTable_cell21.setBorder(Rectangle.NO_BORDER);
		...
		float[] columnWidths1 = {0.2f, 0.5f, 0.3f, 0.3f, 0.3f };
		...
		float[] columnWidths2 = {0.2f, 0.5f, 0.3f, 0.3f, 0.3f };
		...
		float[] columnWidths3 = {0.2f, 0.5f, 0.3f, 0.3f, 0.3f };
		...
		float[] columnWidths4 = {0.2f, 0.5f, 0.3f, 0.3f, 0.3f };
		...
		float[] columnWidths5 = {0.2f, 0.5f, 0.3f, 0.3f, 0.3f };
		...
		float[] columnWidths6 = {0.2f, 0.5f, 0.3f, 0.3f, 0.3f };
		...
		float[] columnWidths7 = {0.2f, 0.5f, 0.3f, 0.3f, 0.3f };
		...
		float[] columnWidths8 = {0.2f, 0.5f, 0.3f, 0.3f, 0.3f };
		...
		float[] columnWidths9 = { 0.2f, 0.5f, 0.3f, 0.3f, 0.3f };
    ...
    while(rs.next())
    {
    	if (a<6)
	    {    		
    		double disPer = rs.getDouble("perProductdisPer");
    		if(disPer > 0)
    		{
    			tempTax = rs.getDouble("taxAmtAfterDiscount");
    		}
    		else
    		{
        		tempTax = rs.getDouble("TaxAmount");
    		}
			...
			String totalWeight = String.valueOf(salePrice);
			table_cell = new PdfPCell(new Phrase(" " + totalWeight));
			table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			table_cell.setBorder(Rectangle.LEFT|Rectangle.RIGHT);
			table.addCell(table_cell);
	
			String totalperitem = String.valueOf(rs.getDouble("totalperitem"));
			table_cell = new PdfPCell(new Phrase(" "+totalperitem));
			table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			table_cell.setBorder(Rectangle.LEFT|Rectangle.RIGHT);
			table.addCell(table_cell);
			
			TotalOfTotalAmtWithoutVatStr = TotalOfTotalAmtWithoutVatStr + Double.parseDouble(totalperitem);
    ...
    if(a>1 && a<=6)
    {
		...
		table_cell = new PdfPCell(new Phrase("cgst:"+df.format(totalTaxAmount/2)+" sgst:"+df.format(totalTaxAmount/2), Normalfont12));
		table_cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		table_cell.setBorder(Rectangle.NO_BORDER);
		/*table_cell.setPaddingBottom(1);*/
		...
		table_cell = new PdfPCell(new Phrase("", Normalfont12));
		table_cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		table_cell.setBorder(Rectangle.NO_BORDER);
		/* table_cell.setPaddingBottom(1);
		...
		table_cell = new PdfPCell(new Phrase("Total\n"+df.format(TotalOfTotalAmtWithoutVatStr), Normalfont12));
		table_cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		table_cell.setBorder(Rectangle.NO_BORDER);
		//table_cell.setColspan(2);
		table.addCell(table_cell);
   ...
   if(a>6 && a<=11 ){
		...
		table_cell = new PdfPCell(new Phrase("\n\n\n\n\n" + df.format(totalTaxAmount/2),Normalfont12));
		table_cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		table_cell.setBorder(Rectangle.NO_BORDER);
		//table_cell.setPaddingBottom(1);
		...
		table_cell = new PdfPCell(new Phrase("SGST:", Normalfont12));
		table_cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		table_cell.setBorder(Rectangle.NO_BORDER);
		//table_cell.setPaddingBottom(1);
		table_cell.setColspan(4);
		...
		//Double TaxAmount = gstAmt;
		table_cell = new PdfPCell(new Phrase(df.format(totalTaxAmount/2),Normalfont12));
		table_cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		table_cell.setBorder(Rectangle.NO_BORDER);
		table_cell.setPaddingBottom(1);
		table_cell.setColspan(1);
		...
		table_cell = new PdfPCell(new Phrase("Discount: "+df.format(totalDiscount), Normalfont12));
		table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		table_cell.setBorder(Rectangle.NO_BORDER);
		//table_cell.setPaddingBottom(1);
		table_cell.setColspan(2);
		...
		table_cell = new PdfPCell(new Phrase("Total:"+df.format(TotalOfTotalAmtWithoutVatStr), Normalfont12));
		table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		table_cell.setBorder(Rectangle.NO_BORDER);
		table_cell.setColspan(2);
		table1.addCell(table_cell);
   ...
   if(a>11 && a<=16 ){
       ...
       table_cell = new PdfPCell(new Phrase("\n\n\n\n\nCGST:", Normalfont12));
		...
		/* table_cell = new PdfPCell(new Phrase("Payment Mode:"+ paymentMode, Normalfont12));
		table_cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		table_cell.setBorder(Rectangle.NO_BORDER);
		table_cell.setPaddingBottom(1);
		table_cell.setColspan(2);
