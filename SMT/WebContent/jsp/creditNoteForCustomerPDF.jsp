...
Long crCustTransactionId = (Long)session.getAttribute("crCustTransactionId");
...
try
{
    ...
    ResultSet rs = stmt.executeQuery("select ccp.pk_credit_customer_id, ccp.total_amount, ccp.balance, ccp.payment, ccp.paymentType, ccp.payment_mode, ccp.insert_date, cd.first_name, cd.last_name, cd.contact_no from credit_customer_payment ccp JOIN customer_details cd on ccp.fk_customer_id=cd.pk_customer_id WHERE pk_credit_customer_id = "+crCustTransactionId);
   	rs.next();
	...
	String transactionId = rs.getString("pk_credit_customer_id");
	...
	shopTable.setWidths(columnWidths1);
		...
		table_cell1 = new PdfPCell(new Phrase("", font10));
		table_cell1.setBorder(table_cell1.NO_BORDER);
		...
		table_cell1 = new PdfPCell(new Phrase(/*"Bill No: "+*/""/*shopPrBillno*/, font10));
		table_cell1.setBorder(table_cell1.NO_BORDER);
		table_cell1.setHorizontalAlignment(Element.ALIGN_LEFT);
		table_cell1.setPaddingTop(2f);
		shopTable.addCell(table_cell1);
		
		table_cell1 = new PdfPCell(new Phrase(""/*address*/, font10));
		table_cell1.setBorder(table_cell1.NO_BORDER);
		table_cell1.setPaddingTop(2f);
		table_cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
		shopTable.addCell(table_cell1);	

		table_cell1 = new PdfPCell(new Phrase(""+/*gstNo*/"", font10));
		table_cell1.setBorder(table_cell1.NO_BORDER);
		table_cell1.setHorizontalAlignment(Element.ALIGN_RIGHT);
		shopTable.addCell(table_cell1);
...
/* 	PdfPTable table1 = new PdfPTable(10);       
    ...
    table_cell = new PdfPCell(new Phrase("Pehenava, Baramati\nPayment Receipt", font10));
	...
	table_cell = new PdfPCell(new Phrase("Transaction Id: "+transactionId+"\nDate:"+creditInsertdate, font10));
	...
	table_cell = new PdfPCell(new Phrase(name, font10));
	table_cell.setBorder(table_cell.LEFT | table_cell.RIGHT | table_cell.BOTTOM);
	table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
	table_cell.setPadding(10.0f);
	table.addCell(table_cell);	
    ...
    // step 5    
     ...
     try{
    	...
    	String embelPassword = ClientDetails.getEmbelEmailPassword();
         ...
         m.setSubject("Credit Customer Transaction");
