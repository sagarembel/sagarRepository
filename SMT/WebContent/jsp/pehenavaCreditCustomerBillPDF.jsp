...
<%
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("select c.ItemName, c.Quantity, c.SalePrice, c.Discount, c.TotalAmount, c.GrossTotal, c.Date, c.totalperitem, c.Gst, c.Igst, c.TaxAmount, c.HsnSacNo , s.contact_no, s.first_name,c.pending_bill_payment, perProductdisPer, taxAmtAfterDiscount, billTime, FkSaleEmployeeId, sb.subcat_name, c.BarcodeNo, c.payment_mode, c.payment_mode, ud.userName from creditcustomerbill c left join customer_details s ON c.fkCrediCustId=s.pk_customer_id JOIN sub_categories sb on c.fkSubCatId=sb.pk_subcat_id join user_details ud on c.cEmpIdFk = ud.pk_user_id	where c.BillNo = "+billno);
