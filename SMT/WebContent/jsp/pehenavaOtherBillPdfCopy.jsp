...
System.out.print(":::::::::::::::::::::::::::::::::::::::::BillNO:-"+billno + "::::::::::::::::::::::::::::");
	...
	try
	{
		...
		rs.next();
			...
			headerTable_cell22 = new PdfPCell(new Phrase("BILL NO: 90000"+billno, font9Bold));
			headerTable_cell22.setHorizontalAlignment(Element.ALIGN_CENTER);
			headerTable_cell22.setPaddingBottom(2);
			headerTable_cell22.setBorder(Rectangle.NO_BORDER);
			headertable22.addCell(headerTable_cell22);
		...
		headerTable_cell21 = new PdfPCell(new Phrase("Name: "+rs.getString("credit_Customer_Name"),	font8));
...
while(rs.next())
{
	...
	Total = Total + Double.parseDouble(vatAmt);
...
{ 
	...
	{
		footerTable_cell3 = new PdfPCell(new Phrase("Cash Amount: "+df.format(Total - Double.parseDouble(saleRerturnCreditAmount)), font8Bold));
	...
	{
		footerTable_cell3 = new PdfPCell(new Phrase("Card Amount: "+df.format(Total - Double.parseDouble(saleRerturnCreditAmount)), font8Bold));
		footerTable_cell3.setHorizontalAlignment(Element.ALIGN_RIGHT);
		footerTable_cell3.setBorder(Rectangle.NO_BORDER);
		footerTable3.addCell(footerTable_cell3);
	}
	...
	footerTable_cell3 = new PdfPCell(new Phrase("No Exchange of Suit, Indo-Western, Sherwani, Blazer, Tie, Pheta, Mojodi, Dupatta, Hosiery and Functional Items", font8));
	footerTable_cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
	footerTable_cell3.setBorder(Rectangle.NO_BORDER);
	footerTable3.addCell(footerTable_cell3);
	...
	footerTable_cell3 = new PdfPCell(new Phrase("No Guarantee of Work Embrodiery and fabric of Garment", font8));
	footerTable_cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
	footerTable_cell3.setBorder(Rectangle.NO_BORDER);
	footerTable3.addCell(footerTable_cell3);
