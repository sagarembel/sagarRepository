			...
			<tbody>
				<%
					for(int i=0;i<list12.size();i++){
						TaxDetailsList sr=(TaxDetailsList)list12.get(i);
				%>
				<tr>
					<td class="align"><%=sr.getSrNo()%></td>
					<td class="align"><%=sr.getTaxPercentage()%></td>
					<td class="align"><%=sr.getTaxName()%></td>
					<td class="align"><%=sr.getStartPrice()%></td>
					<td class="align"><%=sr.getEndPrice()%></td>
