...
public class NumToWord {
	...
	/*
	 * public static void main(String[] args) { NumToWord w = new NumToWord();
	 * Scanner input = new Scanner(System.in);
	 * System.out.print("Enter Number: "); int num = input.nextInt(); String
	 * inwords = w.convert(num); System.out.println(inwords); }
	 */
}